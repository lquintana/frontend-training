...
export default {
  ...
  route: {
    ...
    activate () {
      console.log('Router lifecycle: NewsView activated.')
    },

    deactivate () {
      console.log('Router lifecycle: NewsView deactivated.')
    }
  },

  created () {
    store.on('topstories-updated', this.update)
    console.log('Component lifecycle: NewsView created.')
  },

  destroyed () {
    console.log('Component lifecycle: NewsView destroyed.')
